...
class FindWeatherViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        updateUI()
        FindWeatherRouter.createModule(ref: self)
        location.play()
    }
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        homePresenterObject?.sevenDayWeather(cityName: "tokyo")
        homePresenterObject?.getCurrentWeather(cityName : "tokyo")
...
extension FindWeatherViewController : PresenterToViewHomepageProtocol {
...
extension FindWeatherViewController : UITextFieldDelegate
{
...
extension FindWeatherViewController : UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return  weatherForecast.count - 10
    }
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        ...
        return CGSize(width: Int(yourWidth) - 2, height: 120)
    }
}
